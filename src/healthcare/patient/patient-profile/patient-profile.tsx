...
export const PatientProfile = component$<PatientProfileProps>(({
  ...
  const _getStatusColor = () => {
    switch (patient.status) {
      ...
      case 'inactive': return 'text-neutral-600 bg-neutral-50';
  ...
  const getBMICategory = (bmi: number) => {
    ...
    if (bmi < 25) return { text: 'Normal', color: 'text-success-600' };
  ...
  return (
    ...
    >
        ...
        <Row justifyContent="between" alignItems="center">
          <Row gap="6" alignItems="center">
            ...
            <div class="relative">
              {patient.avatar ? (
                ...
                <div class="w-20 h-20 rounded-full bg-gradient-to-br from-neutral-200 to-neutral-300 flex items-center justify-center shadow-lg ring-4 ring-white">
                  <Icon icon="user" class="w-10 h-10 text-neutral-500" />
                </div>
              )}
              <div class={`absolute -bottom-1 -right-1 w-6 h-6 rounded-full border-4 border-white shadow-md ${
                ...
                patient.status === 'emergency' ? 'bg-error-500 animate-pulse' : 'bg-neutral-400'
              }`} />
            </div>

            {/* Enhanced Basic Info with better typography hierarchy */}
            <div>
              <Text as="h1" weight="bold" size="xl" class="text-neutral-900 text-2xl">
              ...
              <Row alignItems="center" gap="4" class="mt-2">
                ...
                <span class="text-neutral-700 capitalize font-medium">{patient.gender}</span>
                <span class="text-neutral-300">•</span>
              ...
              <Row alignItems="center" gap="4" class="mt-3 text-sm">
                <span class="bg-white/80 px-2 py-1 rounded-md text-neutral-600 font-mono">
                  ID: {patient.id}
                </span>
                {patient.lastVisit && (
                  <>
          ...
          <Row gap="2" alignItems="center">
            {editable && userRole !== 'patient' && (
              <button
                onClick$={onEdit$}
                class="min-h-[44px] min-w-[44px] p-3 text-neutral-500 hover:text-primary-600 hover:bg-white/80 rounded-lg transition-all duration-200 shadow-sm hover:shadow-md"
      ...
      {mode === 'detailed' && (
        <div class="px-6 py-4 bg-gradient-to-r from-neutral-25 to-white border-b border-neutral-200">
          <Row gap="1">
      ...
      <div class="p-6">
        {mode === 'summary' && (
          <Row gap="6">
            ...
            <Column size={{ sm: 12, md: 6, lg: 4 }} gap="3">
              ...
              <Column gap="2">
                <Row gap="2" alignItems="center">
                  <Icon icon="mail" class="w-4 h-4 text-neutral-400" />
                  <span class="text-sm text-neutral-600">{patient.email}</span>
                </Row>
                <Row gap="2" alignItems="center">
                  <Icon icon="phone" class="w-4 h-4 text-neutral-400" />
                  <span class="text-sm text-neutral-600">{patient.phone}</span>
                </Row>
                <Row gap="2" alignItems="center">
                  <Icon icon="map-pin" class="w-4 h-4 text-neutral-400" />
            ...
            <Column gap="3">
              ...
              <Column gap="2">
                ...
                <div class="flex justify-between">
                  <span class="text-sm text-neutral-600">BMI</span>
                ...
                {patient.medicalHistory.allergies.length > 0 ? (
                  patient.medicalHistory.allergies.slice(0, 3).map((allergy, idx) => (
                    <div key={idx} class="flex items-center space-x-2">
                      <Icon icon="alert-triangle" class="w-4 h-4 text-orange-400" />
                      <span class="text-sm text-neutral-600">{allergy}</span>
                    </div>
                  ))
                ) : (
                  <span class="text-sm text-neutral-500">No known allergies</span>
                )}
              </Column>
            </Column>
          </Row>
              ...
              <Row gap="8">
                <Column size={{ sm: 12, lg: 6 }} class="space-y-6">
                  <div>
                    ...
                    <dl class="space-y-3">
                      <div class="flex justify-between">
                        <dt class="text-sm text-neutral-600">Date of Birth</dt>
                        <dd class="text-sm font-medium">{formatDate(patient.dateOfBirth)}</dd>
                      </div>
                      <div class="flex justify-between">
                        <dt class="text-sm text-neutral-600">Gender</dt>
                        <dd class="text-sm font-medium capitalize">{patient.gender}</dd>
                      </div>
                      <div class="flex justify-between">
                        <dt class="text-sm text-neutral-600">Email</dt>
                        <dd class="text-sm font-medium">{patient.email}</dd>
                      </div>
                      <div class="flex justify-between">
                        <dt class="text-sm text-neutral-600">Phone</dt>
                ...
                <Column size={{ sm: 12, lg: 6 }} class="space-y-6">
                  ...
                  <div>
                    ...
                    <dl class="space-y-3">
                      <div class="flex justify-between">
                        <dt class="text-sm text-neutral-600">Name</dt>
                        <dd class="text-sm font-medium">{patient.emergencyContact.name}</dd>
                      </div>
                      <div class="flex justify-between">
                        <dt class="text-sm text-neutral-600">Relationship</dt>
                  ...
                  {patient.medicalHistory.medications.length > 0 ? (
                    <div class="space-y-3">
                      {patient.medicalHistory.medications.map((medication, idx) => (
                        <div key={idx} class="p-4 bg-neutral-50 rounded-lg">
                ...
                <Row gap="6">
                  ...
                  <Column size={{ sm: 12, md: 6, lg: 4 }}>
                    <div class="p-4 bg-neutral-50 rounded-lg">
                      ...
                      <div class="text-2xl font-bold text-neutral-900">{patient.vitals.bloodPressure}</div>
                      <div class="text-sm text-neutral-500">mmHg</div>
                    </div>
                  </Column>
                  ...
                  <Column size={{ sm: 12, md: 6, lg: 4 }}>
                    <div class="p-4 bg-neutral-50 rounded-lg">
                      ...
                      <div class="text-2xl font-bold text-neutral-900">{patient.vitals.heartRate}</div>
                      <div class="text-sm text-neutral-500">bpm</div>
                    </div>
                  </Column>
                  ...
                  <Column size={{ sm: 12, md: 6, lg: 4 }}>
                    <div class="p-4 bg-neutral-50 rounded-lg">
                      <div class="flex items-center justify-between mb-2">
                        ...
                        <div class="w-5 h-5 bg-orange-500 rounded-full" />
                      </div>
                      <div class="text-2xl font-bold text-neutral-900">{patient.vitals.temperature}°</div>
                      <div class="text-sm text-neutral-500">Fahrenheit</div>
                    </div>
                  </Column>
                  ...
                  <Column size={{ sm: 12, md: 6, lg: 4 }}>
                    <div class="p-4 bg-neutral-50 rounded-lg">
                      ...
                      <div class="text-2xl font-bold text-neutral-900">{patient.vitals.weight}</div>
                      <div class="text-sm text-neutral-500">kg</div>
                    </div>
                  </Column>
                  ...
                  <Column size={{ sm: 12, md: 6, lg: 4 }}>
                    <div class="p-4 bg-neutral-50 rounded-lg">
                      <div class="flex items-center justify-between mb-2">
                        ...
                        <div class="w-5 h-5 bg-purple-500 rounded-full" />
                      </div>
                      <div class="text-2xl font-bold text-neutral-900">{patient.vitals.height}</div>
                      <div class="text-sm text-neutral-500">cm</div>
                    </div>
                  </Column>
                  ...
                  <Column size={{ sm: 12, md: 6, lg: 4 }}>
                    <div class="p-4 bg-neutral-50 rounded-lg">
                      <div class="flex items-center justify-between mb-2">
                        ...
                        <div class="w-5 h-5 bg-indigo-500 rounded-full" />
                      </div>
                      <div class="text-2xl font-bold text-neutral-900">{calculateBMI()}</div>
                  ...
                  <Column size={{ sm: 12, md: 6 }}>
                    <div class="p-6 bg-neutral-50 rounded-lg">
                      ...
                      <div class="space-y-3">
                        ...
                        <div>
                          <label class="text-sm text-neutral-600">Relationship</label>
                          <div class="font-medium">{patient.emergencyContact.relationship}</div>
                        </div>
                        <div>
                          <label class="text-sm text-neutral-600">Phone</label>
                  ...
                  <Column size={{ sm: 12, md: 6 }}>
                    <div class="p-6 bg-neutral-50 rounded-lg">
                      ...
                      <div class="space-y-3">
                        ...
                        <div>
                          <label class="text-sm text-neutral-600">Address</label>
        ...
        {mode === 'emergency' && (
          <div class="space-y-6">
            {/* Emergency Contact */}
            <div class="p-6 bg-error-50 border border-red-200 rounded-lg">
            ...
            <div class="p-6 bg-orange-50 border border-orange-200 rounded-lg">
              ...
              {patient.medicalHistory.allergies.length > 0 ? (
                <div class="space-y-2">
                  {patient.medicalHistory.allergies.map((allergy, idx) => (
                    <div key={idx} class="flex items-center space-x-2">
                      <Icon icon="alert-triangle" class="w-5 h-5 text-orange-600" />
                      <span class="font-medium text-orange-900">{allergy}</span>
                    </div>
                  ))}
                </div>
              ) : (
            ...
            <div class="p-6 bg-neutral-50 border border-neutral-200 rounded-lg">
              ...
              <Row gap="4" class="text-sm">
                <Column size={{ sm: 6, md: 3 }}>
                  <label class="font-medium text-neutral-700">Blood Pressure</label>
                  <div class="text-neutral-900">{patient.vitals.bloodPressure}</div>
                </Column>
                <Column size={{ sm: 6, md: 3 }}>
                  <label class="font-medium text-neutral-700">Heart Rate</label>
                  <div class="text-neutral-900">{patient.vitals.heartRate} bpm</div>
                </Column>
                <Column size={{ sm: 6, md: 3 }}>
                  <label class="font-medium text-neutral-700">Temperature</label>
                  <div class="text-neutral-900">{patient.vitals.temperature}°F</div>
                </Column>
                <Column size={{ sm: 6, md: 3 }}>
                  <label class="font-medium text-neutral-700">Weight</label>
                  <div class="text-neutral-900">{patient.vitals.weight} kg</div>
                </Column>
              </Row>
            </div>
          </div>
