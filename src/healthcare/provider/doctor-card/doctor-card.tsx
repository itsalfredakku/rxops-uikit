...
export const DoctorCard = component$<DoctorCardProps>((props) => {
  ...
  const getAvailabilityColor = () => {
    ...
    if (doctor.nextAvailableSlot) {
      ...
      if (diffHours <= 2) return "text-success-normal";
          ...
          <Stack direction="row" alignItems="start" gap="4" wrap="wrap">
            ...
            <Stack direction="column" class="flex-1 min-w-0">
              ...
              <Stack direction="row" alignItems="center" justifyContent="between">
                <div class="text-lg font-bold text-success-normal">
        ...
        >
          <div class="p-6">
            ...
            <Stack direction="row" gap="4">
              ...
              <div class="text-center p-3 bg-neutral-lighter rounded-lg">
                <div class="text-2xl font-bold text-success-normal">₹{doctor.consultationFee}</div>
              ...
              <div class="text-center p-3 bg-neutral-lighter rounded-lg">
                <div class={`text-2xl font-bold ${doctor.isAvailable ? 'text-success-normal' : 'text-error-600'}`}>
                  {doctor.isAvailable ? '●' : '○'}
                </div>
