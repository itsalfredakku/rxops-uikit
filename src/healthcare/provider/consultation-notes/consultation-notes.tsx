...
export const ConsultationNotes = component$<ConsultationNotesProps>((props) => {
  ...
  const getPriorityColor = (priority: MedicalNote['priority']) => {
    switch (priority) {
      case 'critical': return 'text-error-600 bg-error-50 border-red-200';
      case 'urgent': return 'text-orange-600 bg-orange-50 border-orange-200';
      case 'routine': return 'text-success-600 bg-success-50 border-green-200';
  ...
  const notesClasses = mergeClasses(
    "w-full max-w-6xl mx-auto bg-white rounded-lg shadow-sm border border-neutral-200",
    qwikClass,
    className
  );
  ...
  return (
    ...
    >
            ...
            <Row gap="2">
              {templates.length > 0 && (
                <button
                  ...
                  class="px-4 py-2 text-sm font-medium text-neutral-700 bg-white border border-neutral-300 rounded-lg transition-colors duration-200 hover:bg-neutral-50 focus:ring-2 focus:ring-blue-500 focus:border-primary-500"
                >
                  Use Template
                </button>
              )}
              <button
                ...
                class="px-4 py-2 text-sm font-medium text-white bg-primary-600 rounded-lg transition-colors duration-200 hover:bg-primary-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              >
                + New Note
              </button>
            </Row>
        ...
        <Row wrap gap="4" alignItems="center">
          <Row alignItems="center" gap="2">
            ...
            <select
              ...
              class="px-3 py-1 text-sm border border-neutral-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-primary-500"
            >
          ...
          <Row alignItems="center" gap="2">
            <label class="text-sm font-medium text-neutral-700">Sort:</label>
            <select
      ...
      {/* Error Display */}
      {notesStore.error && (
        <div class="p-4 border-b border-neutral-200 bg-error-50">
      ...
      {editorStore.isEditing && (
        <div class="p-6 border-b border-neutral-200 bg-neutral-50">
          <div class="space-y-4">
            <Row gap="4">
              <Column size={{ sm: 12, md: 4 }}>
                ...
                <select
                  ...
                  class="w-full px-3 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-primary-500"
                >
                  <option value="consultation">Consultation</option>
              ...
              <Column size={{ sm: 12, md: 6 }}>
                ...
                <div class="space-y-2 mb-2">
                  {editorStore.currentNote.diagnosis.map((diagnosis) => (
                    <Row key={diagnosis} alignItems="center" justifyContent="between" class="p-2 bg-warning-50 border border-yellow-200 rounded">
              ...
              <Column size={{ sm: 12, md: 6 }}>
                ...
                <div class="space-y-2 mb-2">
                  {editorStore.currentNote.recommendations.map((rec, index) => (
                    <Row key={index} alignItems="center" justifyContent="between" class="p-2 bg-success-50 border border-green-200 rounded">
            ...
            <div class="p-4 bg-primary-50 border border-primary-200 rounded-lg">
              <Row alignItems="center" gap="2" class="mb-3">
                <input
                  ...
                  class="rounded border-neutral-300 text-primary-600 focus:ring-blue-500"
                />
                <label for="followup-required" class="text-sm font-medium text-neutral-700">
                  Follow-up Required
                </label>
              </Row>
                ...
                <Row gap="4">
                  <Column size={{ sm: 12, md: 6 }}>
                    ...
                    <select
                      ...
                      class="w-full px-3 py-2 border border-neutral-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-primary-500"
                    >
            ...
            {/* Save Actions */}
            <Row alignItems="center" justifyContent="between" class="pt-4 border-t border-neutral-200">
              ...
              <Row gap="2">
                <button
                  ...
                  class="px-4 py-2 text-sm font-medium text-neutral-700 bg-white border border-neutral-300 rounded-lg transition-colors duration-200 hover:bg-neutral-50"
                >
                  Cancel
                </button>
                <button
        ...
        {filteredNotes.length === 0 ? (
          ...
          <div class="space-y-4">
            {filteredNotes.map((note) => (
              <div
                key={note.id}
                class="p-6 border border-neutral-200 rounded-lg hover:shadow-md transition-shadow"
              >
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        ...
                        {note.confidentialityLevel !== 'standard' && (
                          <span class="px-2 py-1 text-xs font-medium text-purple-800 bg-purple-100 rounded-full border border-purple-200">
                      ...
                      <div class="text-sm text-neutral-600 mt-1">
                        ...
                        {note.version > 1 && (
                          <span class="ml-2 text-xs text-neutral-500">v{note.version}</span>
                        )}
                      </div>
                    </div>
                  </div>
                      ...
                      {currentUser.canEdit && !note.isLocked && (
                        <Tooltip content="Edit note" position="top">
                          <button
                            ...
                            class="p-2 text-neutral-400 hover:text-primary-600 transition-colors duration-200 hover:bg-primary-50 rounded"
                          >
                      ...
                      {currentUser.canSign && !note.signatures?.length && (
                        <Tooltip content="Sign note" position="top">
                          <button
                            ...
                            class="p-2 text-neutral-400 hover:text-success-600 transition-colors duration-200 hover:bg-success-50 rounded"
                          >
                      ...
                      {currentUser.canEdit && !note.isLocked && (
                        <Tooltip content="Delete note" position="top">
                          <button
                            ...
                            class="p-2 text-neutral-400 hover:text-error-600 transition-colors duration-200 hover:bg-error-50 rounded"
                          >
                ...
                {(note.tags.length > 0 || note.diagnosis?.length || note.recommendations?.length) && (
                  <div class="space-y-3 mb-4">
                    ...
                    {note.diagnosis && note.diagnosis.length > 0 && (
                      <div>
                        <span class="text-sm font-medium text-neutral-700">Diagnosis: </span>
                    ...
                    {note.recommendations && note.recommendations.length > 0 && (
                      <div>
                        <span class="text-sm font-medium text-neutral-700">Recommendations: </span>
                        <List variant="none" size="sm" class="mt-1">
